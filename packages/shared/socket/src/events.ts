export const WS_EVENTS = {
  ...
  VOICE_MESH_JOIN: 'voice:mesh-join',
  VOICE_MESH_LEAVE: 'voice:mesh-leave',
  VOICE_MESH_SIGNAL: 'voice:mesh-signal',
  VOICE_MESH_PEER_JOINED: 'voice:mesh-peer-joined',
  VOICE_MESH_PEER_LEFT: 'voice:mesh-peer-left',
} as const;
