...
import { LAW_ENFORCEMENT_DATA } from './data/lawEnforcementData';
...
export const LawEnforcementPage: React.FC = () => {
  ...
  const data = isUkrainian ? LAW_ENFORCEMENT_DATA.uk : LAW_ENFORCEMENT_DATA.en;
  const sections = data.sections;
  const tToc = data.toc;

  const [activeSectionId, setActiveSectionId] = useState<string>(
    sections[0]?.id || 'legal-process-requirements',
  );
  ...
  return (
    <div className="min-h-screen bg-[#07050f] text-[#E0E0E6] font-sans antialiased selection:bg-purple-600 selection:text-white flex flex-col justify-between">
      <SEOHead
        title="Law Enforcement Guidelines • Legal Process Requirements"
        description={data.hero.description}
        canonical="/safety/law-enforcement"
        structuredData={{
          breadcrumbs: [
            { name: 'Safety', url: '/safety' },
            { name: 'Law Enforcement', url: '/safety/law-enforcement' },
          ],
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-32 pb-24 w-full flex-1">
        ...
        <div className="max-w-4xl mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-950/60 border border-blue-500/30 text-blue-300 text-xs font-bold uppercase tracking-wider mb-6">
                  ...
                  return (
                    <a
                      ...
                      className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all ${
                        isActive
                          ? 'bg-blue-600/20 text-blue-200 border border-blue-500/40 shadow-sm translate-x-1'
            ...
            {sections.map((section) => (
              ...
              >
                ...
                <div className="border-b border-purple-900/30 pb-4">
                  <div className="flex items-center gap-2.5 text-xs font-black tracking-widest text-blue-400 uppercase mb-1">
