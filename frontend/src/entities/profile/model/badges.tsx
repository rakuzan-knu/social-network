...
export const BADGE_DICTIONARY: Badge[] = [
  {
    id: 'DEVELOPER',
    name: 'Developer',
    description: 'Один із творців платформи',
    icon: <DeveloperBadge className="w-6 h-6" />,
  },
  {
    id: 'BETA_TESTER',
    name: 'Beta Tester',
    description: 'Брав участь у закритому бета-тесті',
    icon: <BetaTesterBadge className="w-6 h-6" />,
  },
  {
    id: 'EARLY_SUPPORTER',
    name: 'Early Supporter',
    description: 'Підтримав проєкт на ранній стадії',
    icon: <EarlySupporterBadge className="w-6 h-6" />,
  },
  {
    id: 'MODERATOR',
    name: 'Moderator',
    description: 'Слідкує за порядком на платформі',
    icon: <ModeratorBadge className="w-6 h-6" />,
  },
  {
    id: 'PREMIUM',
    name: 'Premium',
    description: 'Активна преміум-підписка',
    icon: <PremiumBadge className="w-6 h-6" />,
  },
  {
    id: 'CONTRIBUTOR',
    name: 'Contributor',
    description: 'Зробив значний внесок у розвиток',
    icon: <ContributorBadge className="w-6 h-6" />,
  },
  {
    id: 'PARTNER',
    name: 'Partner',
    description: 'Особливий статус партнера',
