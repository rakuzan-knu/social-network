...
import { CheckCircle2, Send, Play, FileText, AtSign } from 'lucide-react';
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {profile?.banner ? (
              <img
                src={profile.banner}
                alt="Banner"
                className="w-full h-full object-cover opacity-25 scale-105 filter blur-md"
                style={{
                  objectPosition: `center ${profile.bannerPosition ?? 50}%`,
                }}
              />
            ) : (
              <div className="w-full h-full bg-gradient-to-br from-purple-900/20 via-pink-900/10 to-indigo-950/30" />
            )}
            <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-[#0c0c10]/80 to-[#0c0c10]" />
          </div>
          ...
          <div className="relative z-10 p-5 flex flex-col gap-4">
            {isProfileLoading ? (
              ...
              <>
                {/* Header: Avatar with Instagram Gradient Ring + Names */}
                <div className="flex items-center gap-3.5">
                  ...
                  >
                    {/* Gradient Ring */}
                    <div className="p-[2.5px] rounded-full bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 shadow-lg shadow-purple-500/10 group-hover/avatar:scale-105 transition-transform">
                      <div className="w-14 h-14 rounded-full overflow-hidden bg-[#111115] border-2 border-[#0c0c10]">
                        {profile.avatar ? (
                          <img
                            src={profile.avatar}
                          ...
                          <div className="w-full h-full flex items-center justify-center text-white font-bold text-lg bg-gradient-to-br from-purple-600 to-indigo-600">
                  ...
                  <div className="flex flex-col min-w-0 flex-1">
                    ...
                    >
                      ...
                      {profile.isVerified && (
                        <CheckCircle2 size={16} className="text-sky-400 fill-sky-400/20 shrink-0" />
                      )}
                    </Link>
                ...
                <div className="grid grid-cols-3 gap-2 bg-white/[0.04] backdrop-blur-md rounded-2xl border border-white/[0.08] p-3 text-center shadow-inner">
                ...
                {recentPosts.length > 0 && (
                  <div className="grid grid-cols-3 gap-1.5 rounded-2xl overflow-hidden border border-white/[0.06] bg-black/40 p-1">
                ...
                {currentUserId !== profile.id && (
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center py-2.5 px-3 rounded-2xl font-semibold text-xs border transition-all cursor-pointer disabled:opacity-50 select-none active:scale-[0.98] ${
                        isFollowing
                          ? isHoveredFollow
