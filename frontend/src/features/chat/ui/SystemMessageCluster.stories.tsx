...
const singleSystemMsg = [
  {
    ...
    messageType: 'SYSTEM',
    body: 'Elena Rostova изменил(а) название группы на "Frontend Architecture"',
...
const clusterSystemMsgs = [
  singleSystemMsg[0],
  {
    ...
    conversationId: 'conv-1',
    messageType: 'SYSTEM',
    body: 'Marcus Vance обновил(а) аватар группы',
  ...
  },
  {
    ...
    conversationId: 'conv-1',
    messageType: 'SYSTEM',
    body: 'Alex Carter добавил(а) @developer в группу',
