        ...
        if (isPlayed) {
          if (activeColor) {
            ...
            barColorClass = isOwnMessage
              ? 'bg-linear-to-t from-purple-400 via-purple-300 to-indigo-300 shadow-[0_0_8px_rgba(192,132,252,0.6)]'
              : 'bg-linear-to-t from-sky-400 via-sky-300 to-cyan-300 shadow-[0_0_8px_rgba(56,189,248,0.6)]';
          }
